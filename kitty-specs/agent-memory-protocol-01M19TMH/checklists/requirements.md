# Specification Quality Checklist: Agent Memory Protocol
...
- The specification treats signed memory as an attributable claim, not truth,
  authorization, or prompt instruction.
